...
# Its a typical Backtracking problem

# Additional System Optimization for interview:
# We have Corners: 1, 3, 7, 9
# We have Edges: 2, 4, 6, 8

# Patterns starting from corners would look same
# Similarly, patterns starting from edges would look same

# Instead of trying out for all 9,
# corner = dfs(1, length - 1)
# edge = dfs(2, length - 1)
# center = dfs(5, length - 1)
